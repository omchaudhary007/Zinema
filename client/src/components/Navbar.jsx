  ...
  return (
    <header className="flex shadow-md py-4 px-4 sm:px-10 bg-white min-h-[70px] tracking-wide z-50 fixed w-full">
      <div className="flex flex-wrap items-center justify-between gap-5 w-full">
        ...
        {/* Hamburger menu overlay and nav */}
        <div
          id="collapseMenu"
          className={`${
            menuOpen
          ...
          {userId ? (
            <div className="flex items-center space-x-4">
              {isAdmin && (
                <Link
                  to="/admin"
                  className="px-4 py-2 text-sm rounded-full font-medium tracking-wide text-white bg-indigo-600 hover:bg-indigo-700 transition-all"
                >
                  Admin Panel
                </Link>
              )}
